...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Button_1.setGeometry(QtCore.QRect(260, 760, 111, 32))
        ...
        self.label_31.setGeometry(QtCore.QRect(20, 620, 211, 16))
        font = QtGui.QFont()
        font.setBold(True)
        self.label_31.setFont(font)
        self.label_31.setObjectName("label_31")
        self.label_32 = QtWidgets.QLabel(self.centralwidget)
        self.label_32.setGeometry(QtCore.QRect(260, 620, 101, 16))
        font = QtGui.QFont()
        font.setBold(True)
        self.label_32.setFont(font)
        self.label_32.setObjectName("label_32")
        self.line_16 = QtWidgets.QFrame(self.centralwidget)
        self.line_16.setGeometry(QtCore.QRect(20, 640, 351, 16))
        self.line_16.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_16.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_16.setObjectName("line_16")
        self.label_33 = QtWidgets.QLabel(self.centralwidget)
        self.label_33.setGeometry(QtCore.QRect(20, 650, 91, 20))
        self.label_33.setObjectName("label_33")
        self.FEM_Elements = QtWidgets.QLineEdit(self.centralwidget)
        self.FEM_Elements.setGeometry(QtCore.QRect(120, 650, 113, 21))
        self.FEM_Elements.setObjectName("FEM_Elements")
        self.label_34 = QtWidgets.QLabel(self.centralwidget)
        self.label_34.setGeometry(QtCore.QRect(290, 650, 71, 20))
        self.label_34.setObjectName("label_34")
        self.line_17 = QtWidgets.QFrame(self.centralwidget)
        self.line_17.setGeometry(QtCore.QRect(20, 670, 351, 16))
        self.line_17.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_17.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_17.setObjectName("line_17")
        self.label_35 = QtWidgets.QLabel(self.centralwidget)
        self.label_35.setGeometry(QtCore.QRect(20, 680, 91, 20))
        self.label_35.setObjectName("label_35")
        self.label_36 = QtWidgets.QLabel(self.centralwidget)
        self.label_36.setGeometry(QtCore.QRect(290, 680, 71, 20))
        self.label_36.setObjectName("label_36")
        self.Time_Step = QtWidgets.QLineEdit(self.centralwidget)
        self.Time_Step.setGeometry(QtCore.QRect(120, 680, 113, 21))
        self.Time_Step.setObjectName("Time_Step")
        self.line_18 = QtWidgets.QFrame(self.centralwidget)
        self.line_18.setGeometry(QtCore.QRect(20, 700, 351, 16))
        self.line_18.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_18.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_18.setObjectName("line_18")
        self.label_37 = QtWidgets.QLabel(self.centralwidget)
        self.label_37.setGeometry(QtCore.QRect(20, 710, 91, 20))
        self.label_37.setObjectName("label_37")
        self.Max_dist = QtWidgets.QLineEdit(self.centralwidget)
        self.Max_dist.setGeometry(QtCore.QRect(120, 710, 113, 21))
        self.Max_dist.setObjectName("Max_dist")
        self.label_38 = QtWidgets.QLabel(self.centralwidget)
        self.label_38.setGeometry(QtCore.QRect(290, 710, 71, 20))
        self.label_38.setObjectName("label_38")
        self.line_19 = QtWidgets.QFrame(self.centralwidget)
        self.line_19.setGeometry(QtCore.QRect(20, 730, 351, 16))
        self.line_19.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_19.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_19.setObjectName("line_19")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 392, 36))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_31.setText(_translate("MainWindow", "Simulation Parameters"))
        self.label_32.setText(_translate("MainWindow", "Default Values"))
        self.label_33.setText(_translate("MainWindow", "FEM Elements"))
        self.label_34.setText(_translate("MainWindow", "20"))
        self.label_35.setText(_translate("MainWindow", "Time Step (s)"))
        self.label_36.setText(_translate("MainWindow", "0.5"))
        self.label_37.setText(_translate("MainWindow", "Max Dist. (m)"))
        self.label_38.setText(_translate("MainWindow", "2000"))
    ...
    def WriteVals(self): 
        ...
        if self.FEM_Elements.text() == '':  
            L14=20
            values.append(L14)
        elif int(self.FEM_Elements.text()) < 2:
            L14=2
            values.append(L14)
        else:
            L14=int(self.FEM_Elements.text())
            values.append(L14)
            
        if self.Time_Step.text() == '': 
            L15=0.5
            values.append(L15)
        else:
            L15=float(self.Time_Step.text())
            values.append(L15)
            
        if self.Max_dist.text() == '': 
            L16=2000
            values.append(L16)
        else:
            L16=float(self.Max_dist.text())
            values.append(L16)
